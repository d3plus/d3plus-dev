...
module.exports = log => {
  ...
  log.timer("creating/updating CONTRIBUTING.md");
  shell.mkdir("-p", ".github");
  new shell.ShellString(`# Contributing
...
\`\`\`html
<script src="../build/${name}.full.js"></script>
<body>
...
\`\`\`sh
https://d3plus.org/examples/${name}/my-cool-example/
\`\`\`
...
Push to your fork and [submit a pull request](https://github.com/d3plus/${name}/compare/). At this point, you're waiting on us. We may suggest some changes or improvements or alternatives.
